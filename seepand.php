    ...
    <main> 
        <div class=" display">
            ...
            <section class="hero">
                 <table>
                    <tr>
                        <th colspan="11"><h2>Account Information</h2></th>
                    </tr>
                    <tr>
                    <th>Account ID</th>
                        <th>Name</th>
                    ...
                    <td><?php echo $rows['ac_id']; ?></td>
                        ...
                        <td><?php echo $rows['hairColor']; ?></td>
                        <td><?php echo $rows['eyeColor']; ?></td>
                        <td><?php echo $rows['height']; ?></td>
                        <td><?php echo $rows['weight']; ?></td>
                        <td><?php echo $rows['city']; ?></td>
                        <td><form action="deletepending.php" method =  "POST">  <button type="submit" name ="deleteUser" value =" <?=  $rows['ac_id']; ?>">Delete</button></form></td>
                        <td><form action="approve.php" method =  "POST">  <button type="submit" name ="deleteUser" value =" <?=  $rows['ac_id']; ?>">Approve</button></form></td>
                    </tr>
                    <?php } ?>
                </table>
            </section>
