...
$query = "SELECT users.*, account.*, dp_box.b_rent FROM users, account, dp_box WHERE DATEDIFF(NOW(), account.month) >= 180 AND users.id=account.id AND account.b_id=dp_box.b_id";
    ...
    <main> 
        <div class=" display">
            ...
            <section class="hero">
                 <table>
                    <tr>
                        <th colspan="7"><h2>Due Payment Account Information</h2></th>
                    </tr>
                    <tr>
                        <th>Account ID</th>
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td><form action="delete.php" method =  "POST">  <button type="submit" name ="deleteUser" value =" <?=  $rows['ac_id']; ?>">Delete</button></form></td>
                        <td><form action="sentACCOUNTdept.php" method =  "POST">  <button type="submit" name ="deleteUser" value =" <?=  $rows['ac_id']; ?>">Send to Account Dept</button></form></td>
