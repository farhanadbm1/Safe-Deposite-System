...
$sql = "SELECT * FROM users, account, dp_box WHERE DATEDIFF(NOW(), account.month) >= 180 AND users.id = account.id";
$result = mysqli_query($conn, $sql); // Change "$query" to "$sql" here
